...
export class AppDrawerComponent extends Component implements IAppDrawerComponent {
		...
		switch (attrName) {
			case "open":
				if (newValue != null) {
					...
					eventUtil.fire(EventName.APP_DRAWER_OPEN, window, {width: 70});
				} else {
					await this.animateOut();
					eventUtil.fire(EventName.APP_DRAWER_CLOSE, window, {width: 70});
				}
				break;
		}
	}
	...
	protected connectedCallback (): void {
		...
		eventUtil.listen(this, EventName.NAVIGATION_START, window, this.close);
	}
