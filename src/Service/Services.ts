...
import {ISyncDB, SyncDB} from "@wessberg/syncdb";
import {SyncDBResource} from "../../Resource/SyncDBResource";
import {IFingerprintStore} from "../Store/FingerprintStore/Interface/IFingerprintStore";
import {FingerprintStore} from "../Store/FingerprintStore/FingerprintStore";
...
export const syncdb: ISyncDB = new SyncDB(SyncDBResource);
...
export const fingerprintStore: IFingerprintStore = new FingerprintStore();
