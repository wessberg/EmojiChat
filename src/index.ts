...
// Set up icons
SvgIconUtil.addIcons([MENU, PEOPLE_FILL, MICROPHONE_FILL, MICROPHONE_OFF, REVERSE_CAMERA_FILL, CLOSE, HAPPY_EMOJI, SAD_EMOJI, ANGRY_EMOJI, FEAR_EMOJI, SURPRISED_EMOJI, DISGUSTED_EMOJI, NEUTRAL_EMOJI, VIDEO_CAMERA_FILL, CAMERA_FILL, SEND_FILL, DOWNLOAD_FILL, IMAGE, CALENDAR_FILL]);
