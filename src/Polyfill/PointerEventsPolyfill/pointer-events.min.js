!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?module.exports=e():"function"==typeof define&&define.amd?define(e):t.PointerEventsPolyfill=e()}(this,function(){"use strict"
	function t(t,e){e=e||Object.create(null)
		var n=document.createEvent("Event")
		n.initEvent(t,e.bubbles||!1,e.cancelable||!1)
		for(var i,r=2;r<p.length;r++)i=p[r],n[i]=e[i]||v[r]
		n.buttons=e.buttons||0
		var o=0
		return o=e.pressure&&n.buttons?e.pressure:n.buttons?.5:0,n.x=n.clientX,n.y=n.clientY,n.pointerId=e.pointerId||0,n.width=e.width||0,n.height=e.height||0,n.pressure=o,n.tiltX=e.tiltX||0,n.tiltY=e.tiltY||0,n.twist=e.twist||0,n.tangentialPressure=e.tangentialPressure||0,n.pointerType=e.pointerType||"",n.hwTimestamp=e.hwTimestamp||0,n.isPrimary=e.isPrimary||!1,n}function e(){this.array=[],this.size=0}function n(t,e,n,i){this.addCallback=t.bind(i),this.removeCallback=e.bind(i),this.changedCallback=n.bind(i),I&&(this.observer=new I(this.mutationWatcher.bind(this)))}function i(t){return"body /shadow-deep/ "+r(t)}function r(t){return'[touch-action="'+t+'"]'}function o(t){return"{ -ms-touch-action: "+t+"; touch-action: "+t+"; }"}function a(){if(N){R.forEach(function(t){t+""===t?(Y+=r(t)+o(t)+"\n",_&&(Y+=i(t)+o(t)+"\n")):(Y+=t.selectors.map(r)+o(t.rule)+"\n",_&&(Y+=t.selectors.map(i)+o(t.rule)+"\n"))})
		var t=document.createElement("style")
		t.textContent=Y,document.head.appendChild(t)}}function s(){if(!window.PointerEvent){if(window.PointerEvent=t,window.navigator.msPointerEnabled){var e=window.navigator.msMaxTouchPoints
		Object.defineProperty(window.navigator,"maxTouchPoints",{value:e,enumerable:!0}),y.registerSource("ms",Z)}else Object.defineProperty(window.navigator,"maxTouchPoints",{value:0,enumerable:!0}),y.registerSource("mouse",x),void 0!==window.ontouchstart&&y.registerSource("touch",q)
		y.register(document)}}function u(t){if(!y.pointermap.has(t)){var e=Error("InvalidPointerId")
		...
		if(!e){var n=Error("InvalidStateError")
			throw n.name="InvalidStateError",n}}function l(t){var e=y.pointermap.get(t)
		return 0!==e.buttons}function h(){window.Element&&!Element.prototype.setPointerCapture&&Object.defineProperties(Element.prototype,{setPointerCapture:{value:V},releasePointerCapture:{value:W},hasPointerCapture:{value:$}})}var p=["bubbles","cancelable","view","detail","screenX","screenY","clientX","clientY","ctrlKey","altKey","shiftKey","metaKey","button","relatedTarget","pageX","pageY"],v=[!1,!1,null,null,0,0,0,0,!1,!1,!1,!1,0,null,0,0],d=window.Map&&window.Map.prototype.forEach,f=d?Map:e
	...
	var m=["bubbles","cancelable","view","detail","screenX","screenY","clientX","clientY","ctrlKey","altKey","shiftKey","metaKey","button","relatedTarget","buttons","pointerId","width","height","pressure","tiltX","tiltY","pointerType","hwTimestamp","isPrimary","type","target","currentTarget","which","pageX","pageY","timeStamp"],E=[!1,!1,null,null,0,0,0,0,!1,!1,!1,!1,0,null,0,0,0,0,0,0,0,"",0,!1,"",null,null,0,0,0,0],b={pointerover:1,pointerout:1,pointerenter:1,pointerleave:1},T="undefined"!=typeof SVGElementInstance,y={pointermap:new f,eventMap:Object.create(null),captureInfo:Object.create(null),eventSources:Object.create(null),eventSourceList:[],registerSource:function(t,e){var n=e,i=n.events
		...
		return this.dispatchEvent(n)},cloneEvent:function(t){for(var e,n=Object.create(null),i=0;i<m.length;i++)e=m[i],n[e]=t[e]||E[i],!T||"target"!==e&&"relatedTarget"!==e||n[e]instanceof SVGElementInstance&&(n[e]=n[e].correspondingUseElement)
	...
	var g={shadow:function(t){return t?t.shadowRoot||t.webkitShadowRoot:void 0},canTarget:function(t){return t&&!!t.elementFromPoint},targetingShadow:function(t){var e=this.shadow(t)
	...
	var R=["none","auto","pan-x","pan-y",{rule:"pan-x pan-y",selectors:["pan-x pan-y","pan-y pan-x"]}],Y="",N=window.PointerEvent||window.MSPointerEvent,_=!window.ShadowDOMPolyfill&&document.head.createShadowRoot,D=y.pointermap,L=25,X=[1,4,2,8,16],k=!1
	try{k=1===new MouseEvent("test",{buttons:1}).buttons}catch(A){}var F,x={POINTER_ID:1,POINTER_TYPE:"mouse",events:["mousedown","mousemove","mouseup","mouseover","mouseout"],register:function(t){y.listen(t,this.events)},unregister:function(t){y.unlisten(t,this.events)},lastTouches:[],isEventSimulatedFromTouch:function(t){for(var e,n=this.lastTouches,i=t.clientX,r=t.clientY,o=0,a=n.length;a>o&&(e=n[o]);o++){var s=Math.abs(i-e.x),u=Math.abs(r-e.y)
		if(L>=s&&L>=u)return!0}},prepareEvent:function(t){var e=y.cloneEvent(t),n=e.preventDefault
		...
		k||(n.buttons=X[n.button],e&&(n.buttons|=e.buttons),t.buttons=n.buttons),D.set(this.POINTER_ID,t),e&&0!==e.buttons?y.move(n):y.down(n)}},mousemove:function(t){if(!this.isEventSimulatedFromTouch(t)){var e=this.prepareEvent(t)
		k||this.prepareButtonsForMove(e,t),e.button=-1,D.set(this.POINTER_ID,t),y.move(e)}},mouseup:function(t){if(!this.isEventSimulatedFromTouch(t)){var e=D.get(this.POINTER_ID),n=this.prepareEvent(t)
		if(!k){var i=X[n.button]
			n.buttons=e?e.buttons&~i:0,t.buttons=n.buttons}D.set(this.POINTER_ID,t),n.buttons&=~X[n.button],0===n.buttons?y.up(n):y.move(n)}},mouseover:function(t){if(!this.isEventSimulatedFromTouch(t)){var e=this.prepareEvent(t)
		k||this.prepareButtonsForMove(e,t),e.button=-1,D.set(this.POINTER_ID,t),y.enterOver(e)}},mouseout:function(t){if(!this.isEventSimulatedFromTouch(t)){var e=this.prepareEvent(t)
		k||this.prepareButtonsForMove(e,t),e.button=-1,y.leaveOut(e)}},cancel:function(t){var e=this.prepareEvent(t)
		y.cancel(e),this.deactivateMouse()},deactivateMouse:function(){D["delete"](this.POINTER_ID)}},K=y.captureInfo,j=g.findTarget.bind(g),U=g.allShadows.bind(g),B=y.pointermap,z=2500,H=200,G="touch-action",q={events:["touchstart","touchmove","touchend","touchcancel"],register:function(t){F.enableOnSubtree(t)},unregister:function(){},elementAdded:function(t){var e=t.getAttribute(G),n=this.touchActionToScrollType(e)
		n&&(t._scrollType=n,y.listen(t,this.events),U(t).forEach(function(t){t._scrollType=n,y.listen(t,this.events)},this))},elementRemoved:function(t){t._scrollType=void 0,y.unlisten(t,this.events),U(t).forEach(function(t){t._scrollType=void 0,y.unlisten(t,this.events)},this)},elementChanged:function(t,e){var n=t.getAttribute(G),i=this.touchActionToScrollType(n),r=this.touchActionToScrollType(e)
		i&&r?(t._scrollType=i,U(t).forEach(function(t){t._scrollType=i},this)):r?this.elementRemoved(t):i&&this.elementAdded(t)},scrollTypes:{EMITTER:"none",XSCROLLER:"pan-x",YSCROLLER:"pan-y",SCROLLER:/^(?:pan-x pan-y)|(?:pan-y pan-x)|auto$/},touchActionToScrollType:function(t){var e=t,n=this.scrollTypes
		...
		this.resetId=setTimeout(t,H)},cancelResetClickCount:function(){this.resetId&&clearTimeout(this.resetId)},typeToButtons:function(t){var e=0
		return("touchstart"===t||"touchmove"===t)&&(e=1),e},touchToPointer:function(t){var e=this.currentTouchEvent,n=y.cloneEvent(t),i=n.pointerId=t.identifier+2
		n.target=K[i]||j(n),n.bubbles=!0,n.cancelable=!0,n.detail=this.clickCount,n.button=0,n.buttons=this.typeToButtons(e.type),n.width=2*(t.radiusX||t.webkitRadiusX||0),n.height=2*(t.radiusY||t.webkitRadiusY||0),n.pressure=t.force||t.webkitForce||.5,n.isPrimary=this.isPrimaryTouch(t),n.pointerType=this.POINTER_TYPE,n.altKey=e.altKey,n.ctrlKey=e.ctrlKey,n.metaKey=e.metaKey,n.shiftKey=e.shiftKey
		var r=this
		...
		if(n){var i=n.out,r=n.outTarget
			y.move(e),i&&r!==e.target&&(i.relatedTarget=e.target,e.relatedTarget=r,i.target=r,e.target?(y.leaveOut(i),y.enterOver(e)):(e.target=r,e.relatedTarget=null,this.cancelOut(e))),n.out=e,n.outTarget=e.target}},touchend:function(t){this.dedupSynthMouse(t),this.processTouches(t,this.upOut)},upOut:function(t){this.scrolling||(y.up(t),y.leaveOut(t)),this.cleanUpPointer(t)},touchcancel:function(t){this.processTouches(t,this.cancelOut)},cancelOut:function(t){y.cancel(t),y.leaveOut(t),this.cleanUpPointer(t)},cleanUpPointer:function(t){B["delete"](t.pointerId),this.removePrimaryPointer(t)},dedupSynthMouse:function(t){var e=x.lastTouches,n=t.changedTouches[0]
		if(this.isPrimaryTouch(n)){var i={x:n.clientX,y:n.clientY}
			e.push(i)
			var r=function(t,e){var n=t.indexOf(e)
				n>-1&&t.splice(n,1)}.bind(null,e,i)
			setTimeout(r,z)}}}
	F=new n(q.elementAdded,q.elementRemoved,q.elementChanged,q)
	var V,W,$,J=y.pointermap,Q=window.MSPointerEvent&&"number"==typeof window.MSPointerEvent.MSPOINTER_TYPE_MOUSE,Z={events:["MSPointerDown","MSPointerMove","MSPointerUp","MSPointerOut","MSPointerOver","MSPointerCancel","MSGotPointerCapture","MSLostPointerCapture"],register:function(t){y.listen(t,this.events)},unregister:function(t){y.unlisten(t,this.events)},POINTER_TYPES:["","unavailable","touch","pen","mouse"],prepareEvent:function(t){var e=t
		return Q&&(e=y.cloneEvent(t),e.pointerType=this.POINTER_TYPES[t.pointerType]),e},cleanup:function(t){J["delete"](t)},MSPointerDown:function(t){J.set(t.pointerId,t)
		var e=this.prepareEvent(t)
		y.down(e)},MSPointerMove:function(t){var e=this.prepareEvent(t)
		y.move(e)},MSPointerUp:function(t){var e=this.prepareEvent(t)
		y.up(e),this.cleanup(t.pointerId)},MSPointerOut:function(t){var e=this.prepareEvent(t)
		y.leaveOut(e)},MSPointerOver:function(t){var e=this.prepareEvent(t)
		y.enterOver(e)},MSPointerCancel:function(t){var e=this.prepareEvent(t)
		y.cancel(e),this.cleanup(t.pointerId)},MSLostPointerCapture:function(t){var e=y.makeEvent("lostpointercapture",t)
		y.dispatchEvent(e)},MSGotPointerCapture:function(t){var e=y.makeEvent("gotpointercapture",t)
		y.dispatchEvent(e)}},tt=window.navigator
	tt.msPointerEnabled?(V=function(t){u(t),c(this),l(t)&&(y.setCapture(t,this,!0),this.msSetPointerCapture(t))},W=function(t){u(t),y.releaseCapture(t,!0),this.msReleasePointerCapture(t)}):(V=function(t){u(t),c(this),l(t)&&y.setCapture(t,this)},W=function(t){u(t),y.releaseCapture(t)}),$=function(t){return!!y.captureInfo[t]},a(),s(),h()
	var et={dispatcher:y,Installer:n,PointerEvent:t,PointerMap:f,targetFinding:g}
	return et})
