import {BASEBALL as IOS_BASEBALL, BASEBALL_FILL as IOS_BASEBALL_FILL, BASKETBALL as IOS_BASKETBALL, BASKETBALL_FILL as IOS_BASKETBALL_FILL, CLOUDY as IOS_CLOUDY, CLOUDY_FILL as IOS_CLOUDY_FILL, CLOUDY_NIGHT as IOS_CLOUDY_NIGHT, CLOUDY_NIGHT_FILL as IOS_CLOUDY_NIGHT_FILL, FOOTBALL as IOS_FOOTBALL, FOOTBALL_FILL as IOS_FOOTBALL_FILL, LOCATION as IOS_LOCATION, MEDICAL as IOS_MEDICAL, MEDICAL_FILL as IOS_MEDICAL_FILL, MOON as IOS_MOON, MOON_FILL as IOS_MOON_FILL, PARTLY_SUNNY as IOS_PARTLY_SUNNY, PARTLY_SUNNY_FILL as IOS_PARTLY_SUNNY_FILL, RAINY as IOS_RAINY, RAINY_FILL as IOS_RAINY_FILL, SNOWY as IOS_SNOWY, TENNISBALL as IOS_TENNISBALL, TENNISBALL_FILL as IOS_TENNISBALL_FILL, THUNDERSTORM as IOS_THUNDERSTORM, THUNDERSTORM_FILL as IOS_THUNDERSTORM_FILL} from "./iOSIcons";
import {IIcon} from "../Interface/IIcon";

const viewBox = "0 0 24 24";

/* tslint:disable */
export const ARROW_UP: IIcon = {
	selector: "arrow-up",
	viewBox,
	template: `<path d="M13 20h-2V8l-5.5 5.5-1.42-1.42L12 4.16l7.92 7.92-1.42 1.42L13 8v12z"/>`
};

export const ARROW_LEFT: IIcon = {
	selector: "arrow-left",
	viewBox,
	template: `<path d="M20 11v2H8l5.5 5.5-1.42 1.42L4.16 12l7.92-7.92L13.5 5.5 8 11h12z"/>`
};

export const ARROW_RIGHT: IIcon = {
	selector: "arrow-right",
	viewBox,
	template: `<path d="M4 11v2h12l-5.5 5.5 1.42 1.42L19.84 12l-7.92-7.92L10.5 5.5 16 11H4z"/>`
};

export const ARROW_DOWN: IIcon = {
	selector: "arrow-down",
	viewBox,
	template: `<path d="M11 4h2v12l5.5-5.5 1.42 1.42L12 19.84l-7.92-7.92L5.5 10.5 11 16V4z"/>`
};

export const CHEVRON_UP: IIcon = {
	selector: "chevron-up",
	viewBox,
	template: `<path d="M7.4 15.4l4.6-4.6 4.6 4.6L18 14l-6-6-6 6 1.4 1.4z"/>`
};

export const CHEVRON_LEFT: IIcon = {
	selector: "chevron-left",
	viewBox,
	template: `<path d="M15.4 16.6L10.8 12l4.6-4.6L14 6l-6 6 6 6 1.4-1.4z"/>`
};

export const CHEVRON_RIGHT: IIcon = {
	selector: "chevron-right",
	viewBox,
	template: `<path d="M8.6 16.6l4.6-4.6-4.6-4.6L10 6l6 6-6 6-1.4-1.4z"/>`
};

export const CHEVRON_DOWN: IIcon = {
	selector: "chevron-down",
	viewBox,
	template: `<path d="M7.4 8.6l4.6 4.6 4.6-4.6L18 10l-6 6-6-6 1.4-1.4z"/>`
};

export const MENU_UP: IIcon = {
	selector: "menu-up",
	viewBox,
	template: `<path d="M7,15L12,10L17,15H7Z" />`
};

export const MENU_LEFT: IIcon = {
	selector: "menu-left",
	viewBox,
	template: `<path d="M14,7L9,12L14,17V7Z" />`
};

export const MENU_RIGHT: IIcon = {
	selector: "menu-right",
	viewBox,
	template: `<path d="M10,17L15,12L10,7V17Z" />`
};

export const MENU_DOWN: IIcon = {
	selector: "menu-down",
	viewBox,
	template: `<path d="M7,10L12,15L17,10H7Z" />`
};

export const CHECK: IIcon = {
	selector: "check",
	viewBox,
	template: `<path d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" />`
};

export const CHECK_CIRCLE: IIcon = {
...
export const PLUS_CIRCLE: IIcon = {
...
export const MINUS: IIcon = {
	selector: "minus",
	viewBox,
	template: `<path d="M19,13H5V11H19V13Z" />`
};

export const MINUS_CIRCLE: IIcon = {
...
export const INFO_CIRCLE: IIcon = {
...
export const HELP_CIRCLE: IIcon = {
...
export const MORE_HORIZONTAL: IIcon = {
...
export const MORE_HORIZONTAL_FILL: IIcon = {
...
export const MORE_VERTICAL: IIcon = {
...
export const MORE_VERTICAL_FILL: IIcon = {
...
export const CLOUD_UPLOAD_FILL: IIcon = {
	selector: "cloud-upload-fill",
	viewBox: CLOUD_UPLOAD.viewBox,
	template: CLOUD_UPLOAD.template
};
...
export const CLOUD_DOWNLOAD_FILL: IIcon = {
	selector: "cloud-download-fill",
	viewBox: CLOUD_DOWNLOAD.viewBox,
	template: CLOUD_DOWNLOAD.template
};

export const REFRESH: IIcon = {
	selector: "refresh",
	viewBox,
...
export const REFRESH_CIRCLE: IIcon = {
...
export const REFRESH_FILL: IIcon = {
...
export const WINDOWS_FILL: IIcon = {
...
export const PRICETAG_FILL: IIcon = {
...
export const CHATBUBBLE_FILL: IIcon = {
...
export const CHATBOXES_FILL: IIcon = {
...
export const TOGGLES_FILL: IIcon = {
...
export const COMPOSE_BOX: IIcon = {
...
export const COMPOSE_BOX_FILL: IIcon = {
...
export const SPEEDOMETER: IIcon = {
...
export const SPEEDOMETER_FILL: IIcon = {
...
export const STOPWATCH_FILL: IIcon = {
...
export const CALENDAR_FILL: IIcon = {
...
export const PHOTOS_FILL: IIcon = {
...
export const ALBUMS_FILL: IIcon = {
...
export const CAMERA_FILL: IIcon = {
...
export const REVERSE_CAMERA: IIcon = {
...
export const REVERSE_CAMERA_FILL: IIcon = {
...
export const COLOR_WAND_FILL: IIcon = {
	selector: "color-wand-fill",
	viewBox: COLOR_WAND.viewBox,
	template: COLOR_WAND.template
};

export const COLOR_FILTER: IIcon = {
...
export const COLOR_FILTER_FILL: IIcon = {
...
export const BRIEFCASE_FILL: IIcon = {
...
export const MEDKIT_FILL: IIcon = {
...
export const MEDICAL: IIcon = {
	selector: "medical",
	viewBox: IOS_MEDICAL.viewBox,
	template: IOS_MEDICAL.template
};

export const MEDICAL_FILL: IIcon = {
	selector: "medical-fill",
	viewBox: IOS_MEDICAL_FILL.viewBox,
	template: IOS_MEDICAL_FILL.template
};

export const INFINITE: IIcon = {
	selector: "infinite",
	viewBox,
...
export const INFINITE_FILL: IIcon = {
	selector: "infinite-fill",
	viewBox: INFINITE.viewBox,
	template: INFINITE.template
};

export const CALCULATOR: IIcon = {
	selector: "calculator",
	viewBox,
...
export const KEYPAD_FILL: IIcon = {
...
export const TELEPHONE_FILL: IIcon = {
	selector: "telephone-fill",
	viewBox: TELEPHONE.viewBox,
...
export const LOCATION: IIcon = {
	selector: "location",
	viewBox: IOS_LOCATION.viewBox,
	template: IOS_LOCATION.template
};

export const LOCATION_FILL: IIcon = {
...
export const LOCATION_OFF: IIcon = {
...
export const PRINTER_FILL: IIcon = {
	selector: "printer-fill",
	viewBox: PRINTER.viewBox,
	template: PRINTER.template
};

export const GAME_CONTROLLER_RETRO: IIcon = {
...
export const GAME_CONTROLLER_RETRO_FILL: IIcon = {
...
export const GAME_CONTROLLER: IIcon = {
...
export const GAME_CONTROLLER_FILL: IIcon = {
...
export const AMERICAN_FOOTBALL: IIcon = {
...
export const AMERICAN_FOOTBALL_FILL: IIcon = {
	selector: "american-football-fill",
	viewBox: AMERICAN_FOOTBALL.viewBox,
	template: AMERICAN_FOOTBALL.template
};

export const BASEBALL: IIcon = {
	selector: "baseball",
	viewBox: IOS_BASEBALL.viewBox,
	template: IOS_BASEBALL.template
};

export const BASEBALL_FILL: IIcon = {
	selector: "baseball-fill",
	viewBox: IOS_BASEBALL_FILL.viewBox,
	template: IOS_BASEBALL_FILL.template
};

export const BASKETBALL: IIcon = {
	selector: "basketball",
	viewBox: IOS_BASKETBALL.viewBox,
	template: IOS_BASKETBALL.template
};

export const BASKETBALL_FILL: IIcon = {
	selector: "basketball-fill",
	viewBox: IOS_BASKETBALL_FILL.viewBox,
	template: IOS_BASKETBALL_FILL.template
};

export const TENNISBALL: IIcon = {
	selector: "tennisball",
	viewBox: IOS_TENNISBALL.viewBox,
	template: IOS_TENNISBALL.template
};

export const TENNISBALL_FILL: IIcon = {
	selector: "tennisball-fill",
	viewBox: IOS_TENNISBALL_FILL.viewBox,
	template: IOS_TENNISBALL_FILL.template
};

export const FOOTBALL: IIcon = {
	selector: "football",
	viewBox: IOS_FOOTBALL.viewBox,
	template: IOS_FOOTBALL.template
};

export const FOOTBALL_FILL: IIcon = {
	selector: "football-fill",
	viewBox: IOS_FOOTBALL_FILL.viewBox,
	template: IOS_FOOTBALL_FILL.template
};

export const BODY: IIcon = {
	selector: "body",
	viewBox,
...
export const PERSON_FILL: IIcon = {
...
export const PERSON_ADD_FILL: IIcon = {
...
export const PEOPLE_FILL: IIcon = {
...
export const MICROPHONE_FILL: IIcon = {
...
export const MICROPHONE_OFF: IIcon = {
...
export const VOLUME_LOW: IIcon = {
	selector: "volume-low",
	viewBox,
	template: `<path d="M7,9V15H11L16,20V4L11,9H7Z" />`
};

export const VOLUME_HIGH: IIcon = {
...
export const PLAY_FILL: IIcon = {
	selector: "play-fill",
	viewBox,
	template: `<path d="M8,5.14V19.14L19,12.14L8,5.14Z" />`
};

export const PLAY_CIRCLE: IIcon = {
...
export const PLAY_CIRCLE_FILL: IIcon = {
...
export const PAUSE_FILL: IIcon = {
	selector: "pause-fill",
	viewBox,
	template: `<path d="M14,19H18V5H14M6,19H10V5H6V19Z" />`
};

export const PAUSE_CIRCLE: IIcon = {
...
export const PAUSE_CIRCLE_FILL: IIcon = {
...
export const STOP_CIRCLE_FILL: IIcon = {
...
export const RECORDING_FILL: IIcon = {
	selector: "recording-fill",
	viewBox: RECORDING.viewBox,
	template: RECORDING.template
};

export const FASTFORWARD: IIcon = {
...
export const VIDEO_CAMERA: IIcon = {
...
export const VIDEO_CAMERA_FILL: IIcon = {
...
export const FILM_FILL: IIcon = {
	selector: "film-fill",
	viewBox: FILM.viewBox,
	template: FILM.template
};

export const FLASK: IIcon = {
	selector: "flask",
	viewBox,
...
export const LIGHTBULB_FILL: IIcon = {
...
export const NUTRITION_FILL: IIcon = {
	selector: "nutrition-fill",
	viewBox: NUTRITION.viewBox,
	template: NUTRITION.template
};

export const FLOWER: IIcon = {
	selector: "flower",
	viewBox,
...
export const FLAME_FILL: IIcon = {
	selector: "flame-fill",
	viewBox: FLAME.viewBox,
	template: FLAME.template
};

export const SUNNY: IIcon = {
	selector: "sunny",
	viewBox,
...
export const PARTLY_SUNNY: IIcon = {
	selector: "partly-sunny",
	viewBox: IOS_PARTLY_SUNNY.viewBox,
	template: IOS_PARTLY_SUNNY.template
};

export const PARTLY_SUNNY_FILL: IIcon = {
	selector: "partly-sunny-fill",
	viewBox: IOS_PARTLY_SUNNY_FILL.viewBox,
	template: IOS_PARTLY_SUNNY_FILL.template
};

export const CLOUDY: IIcon = {
	selector: "cloudy",
	viewBox: IOS_CLOUDY.viewBox,
	template: IOS_CLOUDY.template
};

export const CLOUDY_FILL: IIcon = {
	selector: "cloudy-fill",
	viewBox: IOS_CLOUDY_FILL.viewBox,
	template: IOS_CLOUDY_FILL.template
};

export const RAINY: IIcon = {
	selector: "rainy",
	viewBox: IOS_RAINY.viewBox,
	template: IOS_RAINY.template
};

export const RAINY_FILL: IIcon = {
	selector: "rainy-fill",
	viewBox: IOS_RAINY.viewBox,
	template: IOS_RAINY_FILL.template
};

export const THUNDERSTORM: IIcon = {
	selector: "thunderstorm",
	viewBox: IOS_THUNDERSTORM.viewBox,
	template: IOS_THUNDERSTORM.template
};

export const THUNDERSTORM_FILL: IIcon = {
	selector: "thunderstorm-fill",
	viewBox: IOS_THUNDERSTORM.viewBox,
	template: IOS_THUNDERSTORM_FILL.template
};

export const SNOWY: IIcon = {
	selector: "snowy",
	viewBox: IOS_SNOWY.viewBox,
	template: IOS_SNOWY.template
};

export const MOON: IIcon = {
	selector: "moon",
	viewBox: IOS_MOON.viewBox,
	template: IOS_MOON.template
};

export const MOON_FILL: IIcon = {
	selector: "moon-fill",
	viewBox: IOS_MOON_FILL.viewBox,
	template: IOS_MOON_FILL.template
};

export const CLOUDY_NIGHT: IIcon = {
	selector: "cloudy-night",
	viewBox: IOS_CLOUDY_NIGHT.viewBox,
	template: IOS_CLOUDY_NIGHT.template
};

export const CLOUDY_NIGHT_FILL: IIcon = {
	selector: "cloudy-night-fill",
	viewBox: IOS_CLOUDY_NIGHT_FILL.viewBox,
	template: IOS_CLOUDY_NIGHT_FILL.template
};

export const WARNING: IIcon = {
	selector: "warning",
	viewBox,
	template: `<path d="M0 0h24v24H0z" fill="none"/><path d="M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z"/>`
};

export const ERROR: IIcon = {
	selector: "error",
	viewBox,
...
export const FINGERPRINT: IIcon = {
...
export const KEYBOARD_HIDE: IIcon = {
...
export const AUDIO: IIcon = {
	selector: "audio",
	viewBox: VOLUME_LOW.viewBox,
	template: VOLUME_LOW.template
};
